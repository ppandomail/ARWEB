...
import ar.edu.uade.tic.tesis.arweb.controlador.GestorControlValidacionAccesibilidad;
import ar.edu.uade.tic.tesis.arweb.controlador.GestorValidacionURL;
...
public class Index extends JFrame implements ActionListener, MouseListener {
	...
	private JPanel getPanelDesarrollador() {
		...
		String texto = "<HTML><H5>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp by Pablo Pandolfo (2017) <br> Maestría TIC - INTEC - Fundación UADE </H5> </HTML>";
		jPanelAcercaDe.add(new JLabel(texto));
		return jPanelAcercaDe;
	}	
